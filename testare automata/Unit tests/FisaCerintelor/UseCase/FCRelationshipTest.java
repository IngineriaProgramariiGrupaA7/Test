 ...
 */
public class FCRelationshipTest {

    FCRelationship r;
    String str;

    @Test
    public void testFCRelationshipConstructor() throws Exception{
        System.out.print("Testare constructor FCRelationship ");
        try {
            r=new FCRelationship();
            assertTrue("Test failed",r.getFrom()==null && r.getTo()==null && r.getType()==null);
